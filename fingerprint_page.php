...
<body class="">
        ...
        <div class="row flex-nowrap">
            ...
            <div class="col dashboard">
              <div class="fw-bold mt-4 row">
                <span class="col-auto fs-1">Fingerprint Database</span>
                <div class='col-auto my-auto'>
                  <a href="rfid_attendance" class="btn btn-success">
              ...
              <div class="col-auto my-auto form-check">
                  <input type="checkbox" id="checkbox_os" class="form-check-input" name="view_Openslots" style="border-color: #198754; background-color: #198754;">
                  <label class="form-check-success" for="checkbox_os">View Open Slots</label>
              </div>
              <div class="col my-auto min-vw-30">
    ...
    <script>
      ...
      $("#checkbox_os").change(function() {
          if($(this).prop('checked')) {
            clearInterval(refresh_page);
            $.ajax({
              url: './fingerprint-actions/process.php',
              type: 'POST',
              data: {action : 'view_Openslot'},
              dataType: 'html',
              success: function(result)
              {
                $('#showdata').html(result);
